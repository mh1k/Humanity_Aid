        ...
        <div class="clearfix">
          ...
          <div class="right-column float_right">
            <ul class="list_inline contact-info">
              <li>
                <span class="icon-phone"></span>Phone: +88 01711-1115555
              </li>
              <li class="top-email">
                <span class="icon-back"></span>Email: info@humanity.com
              </li>
            </ul>
          </div>
        </div>
    ...
    <section class="theme_menu stricky">
      <div class="container">
        <div class="row">
          <div class="col-md-3">
            <div class="main-logo">
              <a href="index.php"><img class="logo-img" alt="" src="images/logo/humanity logo.png" /></a>
            </div>
          </div>
          ...
          <div class="right-column">
            <div class="nav_side_content">
              ...
              <div class="search_option">
                <button aria-expanded="false" aria-haspopup="true" class="search tran3s dropdown-toggle color1_bg"
                  data-toggle="dropdown" id="searchDropdown">
